(function () {
    ...
    AppController.$inject = ['$rootScope', '$scope', '$sce', '$state', '$ionicSideMenuDelegate', 'Main', 'Users'];

    function AppController($rootScope, $scope, $sce, $state, $ionicSideMenuDelegate, Main, Users){
        var vm = this;
